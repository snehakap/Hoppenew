...
Angaben in Katalogen und auf der Website von Hoppe-Terrarienbau-Exclusiv.de - Vertrieb durch Hoppe Terrarienbau stellen kein verbindliches Vertragsangebot dar. Der Kunde gibt mit seiner Bestellung ein verbindliches Angebot zum Abschluss eines Kaufvertrages oder Werkvertrages ab. Die Firma Hoppe Terrarienbau kann dieses Angebot innerhalb von zwei Wochen durch eine ausdrückliche Erklärung annehmen. Das Absenden der bestellten Ware oder einer Rechnung an den Kunden steht einer ausdrücklichen Annahmeerklärung gleich.

4. Lieferung

4.1 Bei Bestellungen aus der Bundesrepublik Deutschland versendet Hoppe Terrarienbau, sofern nichts anderes vereinbart ist, die bestellte Ware an die angegebene Lieferadresse.

4.2. Bei Bestellungen aus anderen Staaten stellt Hoppe Terrarienbau die Ware zur Abholung durch den Kunden oder ein von ihm beauftragtes Transportunternehmen bereit. Gibt der Kunde eine Lieferadresse außerhalb der Bundesrepublik Deutschland an und ist nichts Ab weichendes vereinbart, bevollmächtigt er damit Hoppe Terrarienbau, in seinem Namen ein geeignetes Transportunternehmen mit der Zustellung der Ware an die Lieferadresse zu beauftragen.

4.3. Bestellt der Kunde mehrere Artikel, die mangels sofortiger Lieferbarkeit nicht gemeinsam verschickt werden können, liefert Hoppe Terrarienbau die Waren je nach Verfügbarkeit in zwei Teillieferungen, es sei denn, die teilweise Lieferung ist wegen eines funktionellen Zusammenhangs der Artikel oder aus anderen Gründen erkennbar nicht von Interesse für den Kunden. Die Versandkosten gemäß Ziffer 5. werden dem Kunden nur einmal berechnet.
...
5.1 Es gelten die Preise zum Zeitpunkt der Bestellung. Die Preise von Hoppe Terrarienbau sind Einzelhandelspreise ohne der jeweils gültigen gesetzlichen Mehrwertsteuer. Kosten für Verpackung, Versand und Transport werden, sofern nicht ausdrücklich etwas anderes vereinbart ist, gesondert berechnet. Erfolgt die Lieferung als Nachnahmesendung, trägt der Kunde außerdem die Nachnahme- und Geld Übermittlungsgebühren. Bei Beauftragung eines Zustelldienstes mit dem Transport der bestellten Ware in Staaten außerhalb der EU können zudem zusätzliche Gebühren und Zölle anfallen, die der Kunde ebenfalls zu tragen hat.

5.2. Der Kunde hat die Möglichkeit, die bestellte Ware per Nachnahme liefern zu lassen oder per Banküberweisung (nur bei Vorauskasse), per Lastschriftverfahren oder per Bankeinzug (Unterlagen senden wir Ihnen gerne zu) zu bezahlen. Hoppe Terrarienbau behält sich vor, Zahlungsarten im Einzelfall auszuschließen oder nur gegen Vorauszahlung zu liefern.

5.3. Bei der Bestellung von Waren, die nicht im Sortiment der Firma Hoppe Terrarienbau enthalten sind und die auf Wunsch des Kunden geliefert werden, berechnet Hoppe Terrarienbau eine Bearbeitungsgebühr von 15,00 EUR. Die Bearbeitungsgebühr wird auf der Rechnung gesondert ausgewiesen und im Falle der Reklamation nicht ersta et.

6. Lieferfristen

6.1 Sofern keine abweichenden Lieferfristen schriftlich vereinbart sind, liefert Hoppe Terrarienbau bestellte Waren unverzüglich, spätestens jedoch innerhalb von 4-16 Wochen nach Vertragsschluss. Die Lieferfrist ist eingehalten, wenn die Ware innerhalb dieser Frist das Lager verlassen hat.

6.2. Bevollmächtigt der Kunde Hoppe Terrarienbau, in seinem Namen ein Transportunternehmen mit dem Transport der Ware ins Ausland zu beauftragen (Ziff. 4.2.), ist die Lieferfrist mit Bereitstellung der Ware zur Abholung eingehalten.

6.3. Der Kunde hat Hoppe Terrarienbau bei Überschreitung der Lieferfrist eine angemessene Nachfrist zu setzen.

7. Preisanpassung bei langen Lieferfristen 
Ist eine Lieferfrist von mehr als vier Monaten ab Vertragsschluss vereinbart, kann Hoppe Terrarienbau den Preis der Ware entsprechend etwaigen Preisänderungen durch die Vorlieferanten anpassen.

8. Nichtlieferung durch Vorlieferanten

8.1 Ist der bestellte Gegenstand nicht oder vorübergehend nicht lieferbar, wird Hoppe Terrarienbau den Kunden hierüber unverzüglich nach der Bestellung sowie in der Folgezeit in regelmäßigen Abständen informieren. Bis zur Selbstbelieferung durch den Vorlieferanten ist Hoppe Terrarienbau von der Leistungspflicht befreit, es sei denn, Hoppe Terrarienbau hat die Nichtlieferung durch den Vorlieferanten zu vertreten.

8.2. Im Falle des Rücktritts werden bereits auf den Kaufpreis gezahlte Beträge unverzüglich erstattet. Schadensersatzansprüche des Kunden sind ausgeschlossen, es sei denn, Hoppe Terrarienbau hat die Nichtlieferung durch den Vorlieferanten zu vertreten.

9. Rückgaberecht für Verbraucher

9.1 Alle von einem Verbraucher (Ziffer 2.1.) im Wege des Fernabsatzes bestellte Artikel können uneingeschränk t und ohne Angabe von Gründen innerhalb von zwei Wochen nach Erhalt der Ware kostenfrei zurückgegeben werden.

9.2. Dieses Rückgaberecht besteht nicht bei Fernabsatzverträgen zur Lieferung von Waren, die nach der Spezifikation des Kunden angefertigt werden oder eindeutig auf dessen persönliche Bedürfnisse zugeschnitten sind und die aufgrund ihrer Beschaffenheit nicht für eine Rücksendung geeignet sind. 9.3. Der Kunde hat für die Rücksendung eine sichere – nach Möglichkeit die originale – Transportverpackung zu verwenden und die Sendung an folgende Adresse zu richten: Firma Hoppe Terrarienbau GmbH & Co. KG Für die Rücksendung ist die günstigste Versandart (z.B. Standardpaket) zu wählen.

9.4. Ist die Rücksendung auf dem Postwege nicht oder nicht mehr möglich, genügt zur Geltendmachung des Rückgaberechts ein Rücknahmeverlangen, das per Post (Adresse wie in Ziffer 9.3. angegeben). per E-mail zu richten ist. Firma Hoppe Terrarienbau wird dann nach vorheriger Absprache mit dem Kunden die kostenlose Rückholung veranlassen.
...
9.7. Mit rechtzeitiger Absendung der Ware bzw. des Rücknahmeverlangens ist der Kunde nicht mehr an den Kaufvertrag gebunden. Sofern der Kaufpreis bereits gezahlt wurde, erstattet Firma Hoppe Terrarienbau ihn zurück. 9.8. Wichtiger Hinweis: Bei Rückgabe benutzter oder beschädigter Ware behält sich Firma Hoppe Terrarienbau vor, für die Wertminderung und für den Wert der Nutzung der Ware Ersatz zu verlangen. Ersatzansprüche entstehen nicht, soweit die Verschlechterung der Ware ausschließlich auf ihre Prüfung zurückzuführen ist. Der Kunde kann Ersatzansprüche wegen Benutzung der Ware vermeiden, wenn er diese lediglich in dem für eine angemessene 

10. Gewährleistungsbedingungen

10.1. Hoppe Terrarienbau gewährleistet, dass die Produkte zum Zeitpunkt des Versandes nicht mit Fehlern behaftet sind, die den Wert oder die Tauglichkeit zu dem gewöhnlichen Gebrauch aufheben oder mindern. Der Kunde hat die Ware umgehend bei Empfang der Lieferung durch die Spedition auf Vollständigkeit oder etwaige Mängel zu überprüfen und wird im Falle einer Abweichung unverzüglich eine schriftliche Mängelanzeige an Hoppe Terrarienbau senden. Bei äußerlich erkennbaren Transportschäden ist der Kunde angehalten, den Schaden dem Paketzusteller bzw. der Spedition unmittelbar anzuzeigen, schriftlich festzuhalten und Hoppe Terrarienbau sofort zu informieren. Bei versteckten Mängeln ist die Mitteilung unverzüglich nach Feststellung des versteckten Mangels innerhalb der Gewährleistungsfrist vorzunehmen. Die Dauer der Gewährleistung beträgt 24 Monate nach Lieferung. Im Falle einer mangelhaften Ware hat Hoppe Terrarienbau zunächst das Recht, entweder die mangelhafte Ware zu reparieren oder nachzubessern, oder eine Ersatzlieferung vorzunehmen. Gelingt die Reparatur wiederholt nicht oder erfolgt wiederholt keine befriedigende Ersatzlieferung, ist der Kunde berechtigt, entweder den Kaufpreis zu mindern oder vom Vertrag zurückzutreten (Geld zurück). Eine Gewährleistung kann nicht für solche Mängel übernommen werden, die auf unsachgemäße Nutzung oder einer überdurchschnittlichen Beanspruchung der Ware seitens des Kunden zurückzuführen sind, sowie nicht für Verschleißteile. Auf alle Artikel gewähren wir Garantie gemäß den Gewährleistungsbestimmungen der Hersteller unter Vorbehalt deren Zustimmung.

11. Verjährung von Gewährleistungsansprüchen

11.1 Ansprüche für Lieferung von gebrauchten Sachen verjähren wegen Sachmängeln mit Ab lauf einer Frist von einem Jahr ab Lieferung der Sache, bei Neuwaren verjährt die Frist mit Ablauf von zwei Jahren. § 479 BGB bleibt unberührt.

12. Garantie Hinweis: Einige Hersteller gewähren auf ihre Produkte Garantien, welche über die Gewährleistungsrechte hinausgehen. Es gelten die Garantiebestimmungen des Herstellers.

13. Eigentumsvorbehalt

13.1. Die gelieferte Ware bleibt bis zur vollständigen Zahlung des Erwerbspreises Eigentum von Hoppe Terrarienbau. 13.2. Ist der Kunde ein Kaufmann, juristische Person des öffentlichen Rechts oder öffentlich rechtliches Sondervermögen, behält sich Hoppe Terrarienbau darüber hinaus das Eigentum an der gelieferten Ware bis zur Erfüllung aller bereits zum Zeitpunkt des Vertragsabschlusses entstandenen Forderungen einschließlich aller Forderungen aus Anschlussaufträgen und Nachbestellungen (nachfolgend „Gesamtforderung“ genannt) vor. 13.3. Ist der Kunde Kaufmann und gehört die Bestellung zum Betrieb des Handelsgewerbes, tritt er bereits jetzt alle Forderungen, die er aus einer Weiterveräußerung gegen seinen Abnehmer erwirbt, sicherheitshalber in voller Höhe von Hoppe Terrarienbau ab. Der Kunde ist widerruflich zur Einziehung dieser Forderung ermächtigt. Hoppe Terrarienbau wird die Einziehungsermächtigung nur widerrufen und die abgetretenen Forderungen selbst ein ziehen, wenn der Kunde mit seinen Zahlungsverpflichtungen gegenüber Hoppe Terrarienbau in Verzug gerät oder Antrag auf Eröffnung des Insolvenzverfahrens über das Vermögen des Kunden gestellt ist.

13.4. Hoppe Terrarienbau ist verpflichtet, die bestehenden Sicherheiten auf Verlangen des Kunden insoweit freizugeben, als ihr Wert die zu sichernden Forderungen um mehr als 20 % übersteigt. Die Auswahl der freizugebenden Sicherheiten steht im Ermessen von Hoppe Terrarienbau.

13.5. Hoppe Terrarienbau ist bei Verträgen, bei denen die gelieferte Ware unter Eigentumsvorbehalt steht, zum Rücktritt berechtigt, wenn der Käufer mit der Zahlung oder einer Gesamtforderung von mehr als 250,00 EUR in Verzug gerät. Dieses Rücktrittsrecht ist auf Verträge beschränkt, bei denen der Wert der gelieferten Ware maximal 120 % der Gesamtforderung beträgt.

14. Haftung

14.1. Schadensersatzansprüche wegen Pflichtverletzung und aus unerlaubter Handlung sowie Ansprüche auf Ersatz vergeblicher Aufwendungen sind sowohl gegenüber Hoppe Terrarienbau als auch gegenüber seinen Erfüllungs- und Verrichtungsgehilfen ausgeschlossen, es sei denn, der Schaden wurde vorsätzlich oder grob fahrlässig verursacht.
...
14.4. Zur Absicherung des Transportrisikos werden die Lieferungen automatisch transportversichert. Dies gilt auch dann, wenn eine Haftung von Hoppe Terrarienbau aufgrund der vorstehenden Regelungen ausgeschlossen ist, der typischerweise entstehende und vorhersehbare Schaden aber gleichwohl von dem Versicherungsschutz umfasst ist. Weitergehende Ansprüche des Kunden gegen Hoppe Terrarienbau sind in diesem Fall ausgeschlossen. 14.5. Die 24-monatige Gewährleistung auf unsere Produkte gilt nur bei Einhaltung der mit jeder Rechnung/Vertrag ausgehändigten Pflege- und Handhabungsrichtlinien für Terrarien zur Erhaltung der Garantie. 14.6. Bei selbst vorgenommenen baulichen Veränderungen der Terrarien durch den Käufer, wie z.B. nachträgliche Einbauten mit Bohrungen, die Einfluss auf die Dichtigkeit nehmen, erlischt jegliche Gewährleistung und Garantie.

15. Aufrechnungsverbot 

Der Kunde ist nicht zur Aufrechnung berechtigt, es sei denn, die Gegenforderungen sind von Firma Hoppe Terrarienbau nicht bestritten oder rechtskräftig festgestellt.

16. Datenschutz 

Hoppe Terrarienbau verwendet die vom Kunden mitgeteilten Daten wie Name, Adresse, Telefonnummer, Faxnummer und E-Mail-Adresse lediglich zur Abwicklung der Bestellung und sonstiger vertraglicher Beziehung zum Kunden. Daten werden nicht an Dritte weitergegeben. Die Datenschutzpraxis von Hoppe Terrarienbau steht im Einklang mit dem Bundesdatenschutzgesetz (BDSG) sowie dem Teledienstdatenschutzgesetz (TDDSG).
...
Sollte eine Bestimmung dieses Vertrages unwirksam sein oder werden oder sollte der Vertrag eine ausfüllungsbedürftige Lücke enthalten, so berührt dies die Wirksamkeit der übrigen Bestimmungen nicht. An die Stelle der unwirksamen Bestimmung oder der Lücke tri eine dem wirtschaftlichen Zweck der Vereinbarung nahekommende Regelung, die von den Parteien vereinbart worden wäre, wenn sie die Unwirksamkeit der Bestimmung gekannt hä en. 

Hoppe Terrarienbau GmbH & Co. KG · Gewerbering 11 · 47661 Issum Telefon: +49 177-8 11 4125,
E-mail: info@hoppe-terrarienbau.de 
AG Düsseldorf HRA 25284 · PhG: Hoppe GmbH · AG Düsseldorf HRB 85153
Gf: Stefan Sandeep Kaushal USt-IdNr. DE233008217 

Bankverbindung: 
Kontoinhaber: Hoppe Terrarienbau GmbH & Co.KG 
BIC: DUISDE33XXX 
IBAN: DE98 3505 0000 0200 4655 73
...
D-47661 Issum
Deutschland
Telefon +49 (0) 177 - 8114125
E-Mail: info@hoppe-terrarienbau.de
Website: https://www.hoppe-terrarienbau.de
...
Weitere Hinweise, sofern Sie Google Maps nutzen oder die eigebetteten YouTube Videos schauen.
...
Gewerbering 11
47661Issum
Mobil 0177-811 41 25
E-mail: info@hoppe-terrarienbau.de
USt-IdNr. DE233008217
AG Düsseldorf HRA 25284
PhG: Hoppe GmbH · AG Düsseldorf HRB 85153 · Gf: Stefan Sandeep Kaushal
Bankverbindung: IBAN DE98 3505 0000 0200 4655 73 · BIC DUISDE33XXX
verantwortlich für den Inhalt: Stefan Sandeep Kaushal (Anschrift wie oben)
© 2026 Hoppe-Terrarienbau
