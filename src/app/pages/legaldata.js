export const legalData = {
  ...
  agb: `Allgemeine Verkaufsbedingungen der Firma Labelmonster GmbH & Co. KG./ Drucker-Monster.de 
...
(1) Der Käufer ist für einen Zeitraum von 2 Wochen an seine Bestellung gebunden. Diese Frist beginnt an dem Tag, an dem uns die Bestellung zugeht. Wir sind berechtigt, die Bestellung innerhalb dieser 2 Wochen entweder durch Zusendung einer Auftragsbestätigung oder durch Auslieferung der Ware anzunehmen. 
 
(2) Der Lieferumfang richtet sich nach unserer schriftlichen Auftragsbestätigung, sofern nicht die bestellte Ware ohne Auftragsbestätigung geliefert wurde. 
 
§3 PREISE UND ZAHLUNGSBEDINGUNGEN 
 
(1) Unsere Preise verstehen sich ab Werk und zuzüglich der jeweils gültigen gesetzlichen Mehrwertsteuer. Versandkosten sind in den Preisangaben nicht enthalten und werden während des Kaufvorgangs angezeigt. 
(2) Dem Kunden stehen für die Abwicklung von Bestellungen über das Portal Drucker-Monster.de die nachfolgend aufgeführten Zahlungsmittel zur Verfügung: 

PayPal: Die Zahlungsabwicklung erfolgt über den Zahlungsdienstleister PayPal (Europe) S.à r.l. et Cie, S.C.A. Es gelten die PayPal-Nutzungsbedingungen. 

SEPA-Lastschrift: Der Einzug erfolgt nach Erteilung eines entsprechenden Lastschriftmandats durch den Kunden. 

Debit- oder Kreditkarte: Wir akzeptieren Zahlungen über gängige Anbieter (z. B. Visa, Mastercard). Die Belastung erfolgt mit Abschluss der Bestellung. 
...
Nach Redaktionsschluss dieser Homepage Version 2018-11 können sich noch Änderungen an unseren Produkten ergeben haben. Die Abbildungen zeigen zum Teil Sonderausstattungen, die nicht zum Lieferumfang gehören. Farbabweichungen zum Original sind technisch bedingt. Auch behalten wir uns das Recht vor, unsere Produkte jederzeit ohne vorherige Ankündigung zu verbessern. Erkundigen Sie sich nach dem letzten Stand bei der Labelmonster GmbH & Co. KG. 
 
Alle Lieferungen und Leistungen erfolgen zu unseren allgemeinen Zahlungs- und Lieferbedingungen. Trotz sorgfältiger Prüfung aller veröffentlichten Inhalte, übernehmen wir keine Gewähr oder Haftung für Irrtümer und eventuelle Fehler. Ferner haften wir nicht für Hard- und Softwareschäden, die sich aus der Nutzung des Datenträgers ergeben. Nachdruck und Vervielfältigung, auch auszugsweise, nur mit schriftlicher Genehmigung des Herausgebers. 
 
Diese Website nutzt Stockmaterial / Bildlizenzen von Adobe Stock. 
 
Alle Urheberrechte gehören der: 
 
Labelmonster GmbH & Co. KG 
Im Erlengrund 4 
46149 Oberhausen 
 
Telefonnummer: +49 (0) 208 - 620 59 757 
 
Vertretungsberechtigter Geschäftsführer: 
Stefan Sandeep Kaushal 
Registergericht: Duisburg 
Registernummer: HRA 11988 
...
Die Plattform finden Sie unter http://ec.europa.eu/consumers/odr/ `,
  ...
  versand: `Versand- und Zahlungsbedingungen 
